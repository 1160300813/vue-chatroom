  ...
  export default {
    computed: {
      ...mapState({
        ...
        // session: function ({sessions}) { // 用普通函数this指向vue实例,要注意
        //   // console.log("message state>>>>>>>>>.",state);
        //   console.log("message sessions>>>>>>>>>.",sessions);
        //   // console.log("message currentSessionId>>>>>>>>>.",currentSessionId);
        //   console.log("message session>>>>>>>>>.", sessions.find(session => session.id === currentSessionId));
